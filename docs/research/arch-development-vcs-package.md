...
Date: 2026-08-26
Examined baseline: Immich On-Demand 1.2.0.dev0, Arch Linux, Nautilus 50
...
Confirm that the printed Arch version ends in the source commit hash, the Python version is `1.2.0.dev0`, every table destination is owned by the package, the service is active, and Nautilus reports no loader traceback. Then perform ticket 05's mount-scope, action, emblem, settings, replacement-key, and daemon/CLI independence checks.
